...
## clear all caches and autogenerated directories and files
clear:
	rm -rf logs
	rm -rf localstack
	rm -rf .mypy_cache
...
## create environment and set up test database along with the E-commerce system
create-dev:
...
teardown-dev:
	...
	echo "Clearing all caches and autogenerated directories and files"
	make clear
